...
<body>
    <div>
        ...
        <h2>Narrabundah College Video Store</h2>
        ...
        <form id="login" method="" action="">
            ...
            <p>Username: <input type="text" name="user_name" autofocus="autofocus" autocomplete="off" size="20"></p>

            <p>Password: <input type="password" name="user_password" size="20"></p>
